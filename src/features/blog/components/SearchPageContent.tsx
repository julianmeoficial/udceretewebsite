...
export function SearchPageContent({
  ...
  const postResults = useMemo(() => searchPosts(posts, deferred), [posts, deferred]);
  const resourceResults = useMemo(
    () => searchResources(resources, deferred),
    [resources, deferred],
  );
  const eventResults = useMemo(() => searchEvents(events, deferred), [events, deferred]);
  const tramiteResults = useMemo(() => searchTramites(posts, deferred), [posts, deferred]);
